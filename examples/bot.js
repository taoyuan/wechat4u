...
bot.on('login', () => {
   ...
   */
  bot.sendMsg({
    file: fs.createReadStream(path.resolve(FIXTURES, 'test.gif')),
    filename: 'test.gif'
  }, ToUserName)
    .catch(err => {
      bot.emit('error', err)
   ...
   */
  bot.sendMsg({
    file: fs.createReadStream(path.resolve(FIXTURES, 'test.mp4')),
    filename: 'test.mp4'
  }, ToUserName)
    .catch(err => {
      bot.emit('error', err)
   ...
   */
  bot.sendMsg({
    file: fs.createReadStream(path.resolve(FIXTURES, 'test.txt')),
    filename: 'test.txt'
  }, ToUserName)
    .catch(err => {
      bot.emit('error', err)
